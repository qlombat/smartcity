...
function updateValues(time, chartToUpdate) {
    ...
    getSensorValue("MainRoadCarDetectorActorEast", 2, time, chartToUpdate);
    getSensorValue("MainRoadCarDetectorActorWest", 3, time, chartToUpdate);
}
...
function updateEvolutionValues(time, periods) {
    ...
    getSensorEvolution("MainRoadCarDetectorActorEast", 2, time, periods);
    getSensorEvolution("MainRoadCarDetectorActorWest", 3, time, periods);
}
